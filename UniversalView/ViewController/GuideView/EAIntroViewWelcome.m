...
@implementation EAIntroViewWelcome
...
-(void)show:(id)parent type:(int)type{
    switch (type) {
        case WelcomeStyle_CrossDissolve:
        {
             [self showIntroWithCrossDissolve:(UIViewController *)parent];
        }
            break;
        case WelcomeStyle_Basic:
        {
            [self showBasicIntroWithBg:(UIViewController *)parent];
        }
            break;
        case WelcomeStyle_WithFixedTitle:
        {
            [self showBasicIntroWithFixedTitleView:(UIViewController *)parent];
        }
            break;
        case WelcomeStyle_CustomIntro:
        {
            [self showCustomIntro:(UIViewController *)parent];
        }
            break;
        case WelcomeStyle_WithCustomView:
        {
            [self showIntroWithCustomView:(UIViewController *)parent];
        }
            break;
        case WelcomeStyle_SeparatePages:
        {
            [self showIntroWithSeparatePagesInit:(UIViewController *)parent];
        }
            break;
        default:
            break;
...
- (void)showIntroWithCrossDissolve:(UIViewController *)fv{
    ...
    EAIntroView *intro = [[EAIntroView alloc] initWithFrame:fv.view.bounds andPages:@[page1,page2,page3]];
    [intro setDelegate:(id)fv];
    [intro showInView:fv.view animateDuration:0.0];
}



- (void)showBasicIntroWithBg:(UIViewController *)fv {
    EAIntroPage *page1 = [EAIntroPage page];
    page1.title = @"Hello world";
    page1.desc = @"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";
    page1.titleImage = [UIImage imageNamed:@"original"];
...
- (void)showBasicIntroWithFixedTitleView:(UIViewController *)fv{
    EAIntroPage *page1 = [EAIntroPage page];
    page1.title = @"Hello world";
    page1.desc = @"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";
...
- (void)showCustomIntro:(UIViewController *)fv  {
    EAIntroPage *page1 = [EAIntroPage page];
    page1.title = @"Hello world";
    page1.desc = @"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";
    page1.titleImage = [UIImage imageNamed:@"original"];
...
- (void)showIntroWithCustomView:(UIViewController *)fv  {
    EAIntroPage *page1 = [EAIntroPage page];
    page1.title = @"Hello world";
    page1.desc = @"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";
    page1.bgImage = [UIImage imageNamed:@"1"];
    ...
    UIView *viewForPage2 = [[UIView alloc] initWithFrame:fv.view.bounds];
...
- (void)showIntroWithSeparatePagesInit:(UIViewController *)fv  {
    EAIntroView *intro = [[EAIntroView alloc] initWithFrame:fv.view.bounds];
